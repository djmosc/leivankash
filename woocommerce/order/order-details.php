...
<div class="order-details">
	...
	<div class="customer-details">
		<header class="header customer-details-header">
			<h4><?php _e( 'Customer details', 'woocommerce' ); ?></h4>
		</header>
		<div class="content col2-set">
			<?php if ($order->billing_email) echo '<div class="col-1"><h5>'.__( 'Email:', 'woocommerce' ).'</h5><p>'.$order->billing_email.'</p></div>'; ?>
			<?php if ($order->billing_phone) echo '<div class="col-2"><h5>'.__( 'Telephone:', 'woocommerce' ).'</h5><p>'.$order->billing_phone.'</p></div>'; ?>
		</div>
	</div>
