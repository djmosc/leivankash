	...
	<div class="col-2">
		<div class="customer-details">
			...
			<div class="col2-set">
				...
				<?php if ($order->billing_phone) echo '<div class="col-2"><p><b>'.__( 'Telephone:', 'woocommerce' ).'</b><br />'.$order->billing_phone.'</p></div>'; ?>
			</div>
		</div>
		...
		<?php endif; ?>
		<p class="text-center"><a href="<?php echo get_permalink(get_option('woocommerce_shop_page_id')); ?>" class="red-btn"><?php _e("Back to our Bears", THEME_NAME) ?></a></p>
	</div>
</div>