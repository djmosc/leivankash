...
$base_text 	= woocommerce_light_or_dark( $base, '#890a0a', '#ffffff' );
...
$header_content_h1 = "
	...
	background: url(". get_bloginfo('template_url')."/images/logos/leivankash_email.jpg) no-repeat 24px center;
";
?>
<html>
    <head>
