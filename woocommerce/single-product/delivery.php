...
<div class="delivery">
	...
	<div class="clearfix">
		<div class="span alpha five break-on-tablet">
			<p class="small no-margin"><?php _e("Orders placed before 1PM UK time are dispatched the same day.", THEME_NAME); ?></p>
			<p class="small no-margin"><?php _e("Deliveries within the United Kingdom take 5 days; International deliveries arrive within 10 days.", THEME_NAME); ?></p>
		</div>
